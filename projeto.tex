...
\chapter{Revisão de Literatura}\label{sec:revisao}
    ...
    \toprule
        ...
        \textit{cognitive impairment} \textbf{AND} \textit{bipolar disorder} \textbf{AND} \textit{major depressive disorder} & 489 & 30 & 14 &  \\ \midrule
            \textit{cognitive impairment} \textbf{AND} \textit{bipolar disorder} \textbf{AND} \textit{major depressive disorder} \textbf{AND} \textit{sleep} & 27 & 4 & 2 & 1 \\ \midrule
