...
\chapter{Revisão de Literatura}\label{sec:revisao}
    ...
    critérios do DSM-IV, DSM-V e CID-10
    \parencite{american_psychiatric_association_diagnostic_2013,
    american_psychiatric_association_diagnostic_1998,
    organizacao_mundial_da_saude_cid-10_2000}.
    Os estudos variam entre revisões sistemáticas, amostras clínicas e
    populacionais e estudos de caso-controle.
    ...
    bradley_sleep_2017,
    st-amand_sleep_2013}
    Esta mesma tendência se mantém em sujeitos que apresentam estado de risco
    para o desenvolvimento do TB (sintomas sublimiares, depressão,
    características ciclotímicas, risco genético, parentes próximos com TB)
