...
\chapter{Revisão de Literatura}\label{sec:revisao}
    ...
    \toprule
        ...
        (\textit{hypersomnia} \textbf{OR} \textit{insomnia}) \textbf{AND} (\textit{relapse} \textbf{OR} \textit{recurrence}) \textbf{AND} (\textit{bipolar disorder} \textbf{OR} \textit{major depressive disorder}) & 280 & 15 & 9 & 6 \\ \bottomrule
    \end{tabular}%
    }
    \fonte{Próprio Autor}
    \end{table}
