...
\renewcommand{\familydefault}{\sfdefault} % Modifica fonte padrão do documento para sem serifa
...
\chapter{Revisão de Literatura}\label{sec:revisao}
    ...
    \toprule
        ...
        \textit{cognitive impairment} \textbf{AND} \textit{bipolar disorder} \textbf{AND} \textit{major depressive disorder} & 489 & 30 & 14 & 10 \\ \midrule
