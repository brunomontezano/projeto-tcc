...
\begin{resumo}
    ...
    Este estudo será conduzido em tal local, com tais instrumentos, etc.
    Espera-se encontrar como resultado que a insônia/hipersonia se apresentará
    como um preditor para conversão.
    Também espera-se observar que mesmo em amostras recém diagnosticadas com TB,
    o sono já estará relacionado com prejuízo cognitivo e funcional.
