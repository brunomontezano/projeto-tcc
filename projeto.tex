...
\begin{resumo}
    ...
    recém diagnosticados com transtorno bipolar (TB).
    ...
    que mesmo em amostras recém diagnosticadas com TB, o sono já estará relacionado
    com prejuízo funcional e cognitivo.
    ...
    do sono com o prejuízo funcional e cognitivos de sujeitos recém diagnosticados
    com TB.
...
\chapter{Introdução}\label{sec:introducao}
    ...
    de sujeitos recém diagnosticados com TB.
...
\chapter{Objetivos}\label{sec:objetivos}
    ...
    \section{Objetivo Geral}\label{sec:geral}
        ...
        \begin{alineas}
            ...
            \item Avaliar o efeito da insônia/hipersonia para a conversão
            diagnóstica de TDM para TB, bem como, testar a relação de parâmetros
            do sono com o prejuízo funcional e cognitivos de sujeitos recém
    ...
    \section{Objetivos Específicos}\label{sec:especifico}
        ...
        \begin{alineas}[resume]
            ...
            e avaliação objetiva da cognição de sujeitos recém diagnosticados
            com TB;
...
\chapter{Hipóteses}\label{sec:hipoteses}
    ...
    \begin{alineas}
        ...
        de sujeitos com diagnóstico inicial de TB;

        \item Uma pior qualidade do sono geral apresentará uma correlação
        positiva com a medida subjetiva de disfunções cognitivas e com um pior
