...
\begin{resumo}
    ...
    % Pequena introdução justificando o trabalho (há evidências que o sono
    % está relacionado com conversão diagnóstica e pior funcionamento e
    % desempenho cognitivo em amostras tardias com transtornos de humor);
    % Não se sabe o efeito do sono nessas medidas em amostras de sujeitos
    % recém diagnosticados com TB;
    % Sendo assim, o objetivo do estudo é...
    % Em um estudo conduzido em tal local, com tais instrumentos, etc;
    % Espera-se encontrar como resultado (hipóteses);
    % Insônia para conversão, mesmo em amostras recém diagnosticadas com TB,
    % o sono já estará relacionado com funcionamento e cognição;
    % Basicamente, o que já se sabe, o que não se sabe, e o que faremos
    % a partir disso.
...
\chapter{Introdução}\label{sec:introducao}
    ...
    % Introduzir o tema do estudo;
    % Brevemente falar que problemas de sono parecem predizer transtornos de humor;
    % Alguns estudos relacionam alterações do sono com prejuízo no funcionamento
    % e funcionamento cognitivo em sujeitos com transtornos de humor;
    % Estudos estudaram pacientes já diagnosticados há algum tempo com transtorno;
    % Porém não se sabe se o sono age nos prejuízos (cognição e funcionamento)
    % e se sono tem efeito em amostras de inicio da doença (neuroprogressão);
    % Não se sabe se isso tem efeito desde o início do transtorno ou se só se
    % observa em amostras mais tardias e mais prejudicadas;
    % Finalizar com objetivo do estudo.
    ...
    Considerando estes aspectos, este estudo visa avaliar o efeito da
...
\chapter{Revisão de Literatura}\label{sec:revisao}
    ...
    \section{Corpo da revisão}\label{sec:corporevisao}
        ...
        % Modificar frase abaixo para algo tipo: "Em 54% dos estudos observados
        % a insônia foi vista como sintoma pródromico para transtornos de humor."
        Em uma revisão de literatura que verificou a prevalência de sintomas
        de humor como pródromos para o início ou recorrência de episódios,
        a insônia estava presente em 54\% dos trabalhos observados
        ...
        % Retirar o estudo de 1997 do corpo da revisão. E inserir um estudo
        % que fale das queixas de sono como preditor para o TB.
        E um outro estudo constatou que as queixas de sono podem predizer
        sintomas que comprometem a depressão maior
        \parencite{perlis_self-reported_1997}.
        ...
        o domínio cognitivo.
        % Referenciar os estudos abaixo um por frase, e verificar se o
        % segundo trabalho se refere a transtornos de sono ou não.
        ...
        dos sujeitos. Um outro estudo verificou piores escores no 
        ...
        % Verificar esse estudo do Kanady (2017) novamente e reformular a
        % frase abaixo de maneira mais clara.
        \textcite{kanady_association_2017} examinou a associação entre sono e
        cognição no TB e também avaliou se havia associação entre a manipulação
        terapêutica do sono e a melhora no quadro cognitivo.
        ...
        % Realizar um fechamento para a seção: falar sobre o sono na conversão,
        % e seu efeito no funcionamento e cognição, e bater novamente na tecla
        % da novidade de avaliar em amostra recém diagnosticada esse efeito.
