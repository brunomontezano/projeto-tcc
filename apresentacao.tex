...
\institute{\includegraphics[width=0.3\textwidth]{img/logoucpel.png}
            \includegraphics[width=0.35\textwidth]{img/logoppgsc.png}}
...
\begin{frame}
    ...
    e cognitivos de sujeitos recentemente diagnosticados com TB
...
\begin{frame}
    ...
    \begin{block}{Avaliar o efeito da insônia/hipersonia:}
        ...
        \begin{itemize}
            ...
            \item No funcionamento global de sujeitos recentemente diagnosticados com TB
    ...
    \begin{block}
        ...
        de funcionamento e cognição (objetiva e subjetiva) em sujeitos recentemente
...
\frametitle{Métodos}
    ...
    \centering
    \Ovalbox{585 sujeitos diagnosticados com TDM}
    ...
    \begin{block}{Processamento e análise de dados}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Análise bivariada: qui-quadrado, teste T de Student,
                teste Mann-Whitney, correlação de Pearson ou Spearman
